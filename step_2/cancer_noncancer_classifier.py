...
def main():
    ...
    train_dir = '../datasets/cancer_vs_noncancer_v2/train'
    validation_dir = '../datasets/cancer_vs_noncancer_v2/val'
    test_dir = '../datasets/cancer_vs_noncancer_v2/test'
    ...
    plt.ylabel('Accuracy')
    plt.legend()
    plt.savefig('cancer_noncancer_accuracy.png')
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig('cancer_noncancer_loss.png')

    plt.show()

    torch.save(model.state_dict(), '../weights/cancer_noncancer_model_10epochs.pth')
